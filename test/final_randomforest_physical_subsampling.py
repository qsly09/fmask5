...
def main(resource, destination, ci, cn) -> None:
    ...
    for task in tasks:
        ...
        # physical rules
        key = "randomforest_physical_subsampling"
        ...
        fmask.rf_cloud.subsampling_size = 1 # do not skip pixel to do the classification
        fmask.rf_cloud.subsampling_trigger_min = 140000 # set the subsampling trigger min
        ...
        if fmask.physical.activated:
            fmask.rf_cloud.load_model() # load the trained random forest model for cloud detection
