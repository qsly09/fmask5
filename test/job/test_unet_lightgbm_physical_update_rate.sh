#!/bin/bash
#SBATCH -J light_phy_tune_update
...
python test_unet_lightgbm_physical_update_rate.py --ci=$SLURM_ARRAY_TASK_ID --cn=$SLURM_ARRAY_TASK_MAX --resource=$FOLDER_SRC --destination=$FOLDER_DES
