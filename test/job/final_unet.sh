...
python final_unet.py --ci=$SLURM_ARRAY_TASK_ID --cn=$SLURM_ARRAY_TASK_MAX --resource=$FOLDER_SRC --destination=$FOLDER_DES
...
FOLDER_DES='/gpfs/sharedfs1/zhulab/Shi/ProjectCloudDetectionFmask5/Final/L8BIOME/unet' # end names will be provided afterward
python final_unet.py --ci=$SLURM_ARRAY_TASK_ID --cn=$SLURM_ARRAY_TASK_MAX --resource=$FOLDER_SRC --destination=$FOLDER_DES

FOLDER_SRC='/scratch/shq19004/ProjectCloudDetectionFmask5/ReferenceDataset/S2ALCD' # 1350 cores in total
FOLDER_DES='/gpfs/sharedfs1/zhulab/Shi/ProjectCloudDetectionFmask5/Final/S2ALCD/unet' # end names will be provided afterward
python final_unet.py --ci=$SLURM_ARRAY_TASK_ID --cn=$SLURM_ARRAY_TASK_MAX --resource=$FOLDER_SRC --destination=$FOLDER_DES

FOLDER_SRC='/scratch/shq19004/ProjectCloudDetectionFmask5/ReferenceDataset/S2WHUCDPLUS' # 1350 cores in total
FOLDER_DES='/gpfs/sharedfs1/zhulab/Shi/ProjectCloudDetectionFmask5/Final/S2WHUCDPLUS/unet' # end names will be provided afterward
python final_unet.py --ci=$SLURM_ARRAY_TASK_ID --cn=$SLURM_ARRAY_TASK_MAX --resource=$FOLDER_SRC --destination=$FOLDER_DES
